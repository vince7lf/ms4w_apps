...
function Mapserv_pan(direction)
{
  ...
  if(direction == 'n') {
    x = (this.width-1)/2.0; // x
    y = 0 - (this.height * this.pansize)/2.0; // y
  } else if(direction == 'nw') {
    x = 0 - (this.width * this.pansize)/2.0; // x
    y = 0 - (this.height * this.pansize)/2.0; // y
  } else if(direction == 'ne') {
    x = (this.width-1) + (this.width * this.pansize)/2.0; // x
    y = 0 - (this.height * this.pansize)/2.0; // y
  } else if(direction == 's') {
    x = (this.width-1)/2.0; // x
    y = (this.height-1) + (this.height * this.pansize)/2.0; // y
