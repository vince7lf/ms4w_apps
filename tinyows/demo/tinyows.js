...
function init() {
  ...
  wfs = new OpenLayers.Layer.Vector("Editable Features", {
      ...
      protocol: new OpenLayers.Protocol.WFS({
          version: "1.1.0",
          srsName: "EPSG:31467",
          url: "http://127.0.0.1:8787/cgi-bin/tinyows.exe",
          featureNS :  "http://www.tinyows.org/",
          featureType: "frida",
          geometryName: "geom",
          schema: "http://127.0.0.1:8787/cgi-bin/tinyows.exe?service=wfs&request=DescribeFeatureType&version=1.1.0&typename=tows:frida"
      })
  });
